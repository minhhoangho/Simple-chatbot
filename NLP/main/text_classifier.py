...
from preprocessor import Preprocessor as CustomPreprocessor
from gensim.models.word2vec import Word2Vec
from gensim.models import KeyedVectors


class TextClassifier:
    def __init__(self, word2vec_dict, model_path, max_length=20, n_epochs=15, batch_size=6, n_class=5):
...
if __name__ == '__main__':
    ...
    word2vec_model = Word2Vec.load('../models/VNCorpus4.bin')
    keras_text_classifier = TextClassifier(word2vec_dict=word2vec_model, model_path='../models/sentiment_model4.h5',
    ...
    test_sentence = ['đạo hàm của sin(x)','bạn là ai', 'tạm biệt nhé', 'hi', 'hello', 'trái đất hình gì','giới thiệu đi','mai có mưa không']
